...
eval("window.frames['caozha_NEditor'].document.getElementsByTagName('BODY')[0].innerHTML=window.parent.document.getElementById('"+ContentID+"').value;");
...
if(eval("window.parent.document.getElementById('"+ContentID+"').value!=window.frames['caozha_NEditor'].document.getElementsByTagName('BODY')[0].innerHTML")){
eval("window.parent.document.getElementById('"+ContentID+"').value=window.frames['caozha_NEditor'].document.getElementsByTagName('BODY')[0].innerHTML;");
}
}
